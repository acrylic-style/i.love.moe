  ...
  return (
    <main className="mx-auto mt-[8vh] max-w-3xl">
      <Card className="bg-card/95 py-4 shadow-2xl backdrop-blur sm:py-8">
        ...
        <CardContent className="flex flex-wrap items-center gap-4 px-6 text-sm text-muted-foreground sm:px-10"><span>現在ベータ公開中です。Modの対応プラットフォームやバージョンは利用状況によって拡大予定です。</span><a className={buttonVariants({ variant: "outline" })} href="/plus">Plusを見る</a></CardContent>
      </Card>
    </main>
  );
}
