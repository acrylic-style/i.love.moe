...
export function VisibilityFields({ initialVisibility = "unlisted", hasPassphrase = false, idPrefix = "share" }: {
  ...
  return <fieldset className="space-y-3 rounded-lg border p-4">
    ...
    {visibility === "passphrase" && <div className="space-y-2 pt-2">
      ...
      <PassphraseInput id={`${idPrefix}-passphrase`} required={!hasPassphrase}
        placeholder={hasPassphrase ? "変更するときだけ入力" : "4文字以上100文字以内"} />
