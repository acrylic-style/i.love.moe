...
export function PassphraseInput({ id, required, placeholder, autoFocus = false, autoComplete = "new-password" }: {
  id: string;
  required?: boolean;
  placeholder?: string;
  autoFocus?: boolean;
  ...
  return <div className="flex gap-2">
    ...
    <Button className="w-24" type="button" variant="outline" aria-pressed={visible}
